 ...
 * remote URLs from Google, GitHub and Supabase storage, and a broken one
 * should quietly fall back to initials instead of erroring a whole page.
 */
...
export function ProductLogo({
  ...
  return (
    <span
      ...
      className={cn(
        "inline-flex shrink-0 items-center justify-center rounded-xl border border-ink-900/8 bg-gradient-to-br from-paper-200 to-paper-300 font-semibold text-ink-500",
        className
      )}
    >
      {initials(name)}
