    ...
    <div className="rounded-xl border border-ink-900/10 bg-paper-200/50">
      <div className="flex items-center justify-between border-b border-ink-900/8 px-3 py-1.5">
        ...
        <button
          type="button"
          onClick={onCopy}
          className="inline-flex items-center gap-1.5 text-[12px] font-medium text-violet-600 hover:underline"
        >
          {copied ? <Check className="h-3.5 w-3.5 text-signal-500" /> : <Copy className="h-3.5 w-3.5" />}
          {copied ? "Copied" : "Copy"}
        </button>
      </div>
