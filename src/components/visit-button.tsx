...
export function VisitButton({
  ...
  const styles =
    variant === "primary"
      ? "bg-ink-900 text-white hover:bg-oxblood-500"
      : "border border-ink-900/12 bg-paper-100 text-ink-900 hover:border-oxblood-500/40 hover:text-oxblood-600";
  ...
  return (
    <a
      ...
      className={cn(
        "inline-flex items-center justify-center gap-1.5 rounded-xl px-4 py-2.5 text-sm font-medium shadow-card transition active:scale-[0.98]",
        styles,
        className
      )}
    >
