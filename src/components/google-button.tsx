...
/**
 * One-click sign in. Sign-up friction is the thing that stops a launchpad
 * filling up, so this is a first-class button everywhere it helps rather than
 * something hidden behind "more options".
 */
export function GoogleButton({
  ...
  async function signIn() {
    setLoading(true);
    trackEvent("signin_start", { meta: { provider: "google" } });
