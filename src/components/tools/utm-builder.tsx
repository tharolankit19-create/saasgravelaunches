    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        <div className="flex items-stretch gap-2">
          <div className="min-w-0 flex-1 overflow-x-auto rounded-xl border border-ink-900/20 bg-paper-100 px-3.5 py-2.5 font-mono text-[13px] text-ink-900">
          ...
          <button
            ...
            onClick={copy}
            disabled={!result}
            className="inline-flex shrink-0 items-center gap-1.5 rounded-xl bg-ink-900 px-4 text-[13px] font-medium text-paper-100 transition hover:bg-ember-500 disabled:opacity-50"
          >
