...
export function ShareRow({
  ...
  const btn =
    "inline-flex items-center gap-1.5 rounded-xl border border-ink-900/10 bg-paper-100 px-3 py-1.5 text-[13px] font-medium text-ink-700 transition hover:border-ember-500/40 hover:text-ember-600";
