...
export const PRODUCTS: Record<ProductKey, ProductSpec> = {
  ...
  directory: {
    ...
    slots: null,
    placement: null,
    tagline: "30 high-DR directories, submitted by hand — plus a free launch on the board.",
    perks: [
      "Submitted to 30 high-DR startup directories by hand",
    ...
    envKey: "DODO_PRODUCT_ID_DIRECTORY_49",
  },
  directoryPro: {
    key: "directoryPro",
    name: "Growth List",
    ...
    slots: null,
    placement: null,
    tagline: "70 high-DR directories, do-follow only, plus a Featured week.",
    perks: [
      "Submitted to 70 high-DR directories by hand",
  ...
  directoryMax: {
    ...
    slots: null,
    placement: null,
    tagline: "100+ high-DR directories, do-follow only — the full weekend, bought back.",
    perks: [
      "Submitted to 100+ high-DR directories by hand",
    ...
    envKey: "DODO_PRODUCT_ID_DIRECTORY_149",
  },
  premium: {
    key: "premium",
    name: "Premium",
